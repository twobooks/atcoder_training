...
# tree.query(1, 3, "sum") # 9
# tree.update(0, 10) # [10, 1, 5, 3, 13, 7, 2, 7, 2]
# tree.query(0, 8, "min") # 0
# tree.update(2, -1) # [10, 1, -1, 3, 13, 7, 2, 0, 2]
# tree.query(0, 2, "min") # -1

# array = [1, 2, 3, 4, 5]
# tree = SegmentTree(array)
# tree.update_range(0, 2, 6) # 6 6 6 4 5
# tree.update_range(1, 4, 2) # 6 2 2 2 2
# tree.query(0, 3, "min") # 2
